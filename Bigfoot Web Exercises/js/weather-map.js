...
//      weather?lat=${SALat}&lon=${SAlong}&appid=${OPEN_WEATHER_APPID}&units=imperial`).done
//     (data=>{
//         console.log(data);
...
const apiKey = '5ab920b555f2d08a406e648c9e91d3ce'; //

// Replace 'London' with the name of the city you want to get the weather for
const apiUrl = `https://api.openweathermap.org/data/2.5/weather?q=London&appid=${apiKey}`;

// fetch(apiUrl)
//     .then(response => response.json())
//     .then(data => {
//         // This will log the weather data for London to the console
//         console.log(data);
//     })
//     .catch(error => {
