...
//     }else {
//     return "I dont know anything about the ${color}";
//
 ...
 function analyzeColor(color){
     switch (color) {
         ...
         case "red":
             return ("roses are red");
         default:
             return ("im sorry I dont know that color");
     }
 }
...
function calculateTotal(luckyNumber, totalAmount) {
    ...
    alert ("your price after discount is ${priceAfterDiscount}");
...
if (wantsToEnterNumber){
    ...
    if (userNumber < 0 ){
        ...
        alert ( "that number is nor negative or positive")
    }
}
